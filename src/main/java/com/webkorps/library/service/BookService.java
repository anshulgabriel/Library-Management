...
public class BookService {
    ...
    public void updateBook(HttpServletRequest request, HttpServletResponse response, long bookIntId,
        ...
        bookName = bookName.trim().isBlank() ? savedBook.get().getBookName() : bookName;
        bookAuthor = bookAuthor.trim().isBlank() ? savedBook.get().getBookAuthor() : bookAuthor;
        bookEdition = bookEdition.trim().isBlank() ? savedBook.get().getBookEdition() : bookEdition;
        bookQuantity = bookQuantity <= 0 ? savedBook.get().getQuantity() : bookQuantity;
